...
class PlaybookEngine:
    ...
    def load(self, name: str) -> Playbook | None:
        ...
        try:
            ...
            playbook = Playbook(
                ...
                author=data.get("author", "Siyarix User"),
    ...
    def create_bugbounty_recon(self) -> Playbook:
        ...
        playbook.steps = [
            ...
            PlaybookStep(
                ...
                command="siyarix report generate --findings nuclei-results.txt",
    ...
    def create_incident_response(self) -> Playbook:
        ...
        playbook.steps = [
            ...
            PlaybookStep(
                name="report",
                command="siyarix report generate --iocs iocs.json --timeline timeline.json",
