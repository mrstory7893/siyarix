...
_MODES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "key": "[3]",
        "name": "Direct Command",
        "cmd": 'siyarix run "scan target.com"',
        "shortcut": "/3",
    ...
    },
    {
        ...
        "cmd": "siyarix workflow run pentest.yaml",
        "shortcut": "/5",
    ...
    },
    {
        ...
        "cmd": "siyarix team --session ops-room-1",
        "shortcut": "/8",
...
def print_mode_dispatcher(console: Console, theme: str, active_mode_num: str = "1") -> None:
    ...
    table = Table(
        ...
        border_style=border,
        title=f"[bold {accent}]⚡ SIYARIX MODE DISPATCHER[/bold {accent}]",
