"""Siyarix Scan Scheduler — Persistent background cron and recurring scan coordinator."""
...
SCHEDULES_FILE = Path.home() / ".siyarix" / "schedules.json"
...
scheduler_service = SiyarixScheduler()
