...
class OnboardingWizard:
    ...
    def _step_model_provider(self) -> None:
        ...
        self.console.print("──────────────────────────────────────────────────────────")
        self.console.print(
            "Siyarix uses Large Language Models to interpret commands and plan execution steps."
        )
        ...
        if choice == "1":
            ...
            os.environ["SIYARIX_PROVIDER"] = "ollama"
        elif choice == "2":
            ...
            os.environ["SIYARIX_PROVIDER"] = "gemini"
        elif choice == "3":
            ...
            os.environ["SIYARIX_PROVIDER"] = "openai"
    ...
    def _step_tool_discovery(self) -> None:
        ...
        self.console.print("──────────────────────────────────────────────────────────")
        self.console.print(
            "Siyarix scans your local PATH and WSL instances to detect installed penetration tools."
        )
