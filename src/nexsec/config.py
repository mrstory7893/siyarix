...
DESCRIPTIONS: dict[str, str] = {
    ...
    "use_tor": "Route supported outbound traffic through Tor SOCKS proxy",
    "tor_mode": "Tor policy: disabled | auto | enabled",
    "tor_proxy_url": "Tor SOCKS proxy URL (e.g., socks5://tor-proxy:9050)",
    "rotate_identity": "Rotate identity profile (proxy/user-agent/device) between outbound requests",
