...
> [!NOTE]
> The one exception to this is the [Plugin Exception](legal-plugin-exception). Third-party plugins can use any license, allowing developers to build specific workflows while the core engine remains open.
