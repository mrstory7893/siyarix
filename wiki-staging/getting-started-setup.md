...
- **[Your First Run](getting-started-first-run)** — Let's execute your very first automated security workflow.
- **[Configuration Deep-Dive](getting-started-configuration)** — Want to see *every* possible setting? Check out the full reference.
