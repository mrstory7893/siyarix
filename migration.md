...
3. Check `~/.siyarix/` directory structure after first run
4. Try `siyarix --help` and `siyarix -h` for hidden CLI flags
5. Read source code (it's open source!) — `src/` or `siyarix/` directories
