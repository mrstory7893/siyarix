...
1. **[Installation Guide](getting-started/installation.md)** — Get Siyarix running on your machine.
2. **[Onboarding Wizard](getting-started/onboarding.md)** — Let our interactive wizard help you set up your API keys and environment.
3. **[Setup & Configuration](getting-started/setup.md)** — A deeper dive into customizing your setup.
4. **[Your First Run](getting-started/first-run.md)** — A gentle walkthrough of your very first Siyarix command.

### 🛡️ For Security Operators
Ready to put Siyarix to work? Dive into our operational guides:
- **[Interactive Chat (REPL)](user/interactive-chat.md)** — Learn how to use the powerful interactive terminal.
- **[Security Workflows](user/security-workflows.md)** — Best practices for recon, vulnerability assessment, and incident response.
- **[Cloud & IaC Scanning](user/cloud-scanning.md)** — How to secure your cloud environments and infrastructure code.
- **[Compliance Frameworks](user/compliance-frameworks.md)** — Map your scans to SOC 2, HIPAA, ISO 27001, and more.

### 💻 For Developers & Contributors
Looking under the hood or wanting to write some code? Start here:
- **[Contribution Guide](developer/contribution-guide.md)** — Our workflow, standards, and how you can help!
- **[Codebase Overview](developer/codebase-overview.md)** — A comprehensive map of our 82+ source modules.
- **[Testing Standards](developer/testing.md)** — How we ensure reliability with pytest and CI/CD.
- **[Module Architecture](developer/module-architecture.md)** — Component design and responsibilities.
