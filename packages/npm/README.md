...
- The Siyarix Python package is installed automatically on first run
...
- 80+ tool output parsers for structured findings extraction
...
Full documentation: https://github.com/mufthakherul/siyarix/tree/main/docs
